...
# Script arguments
parser.add_argument('--path', metavar='Dataset path', type=str, help='Path to the RGB video dataset', required=True)
...
# Executes extraction
dt.extract_from_dataset(args.path, args.dest, args.nb_frames, args.chunks, args.s, args.t, args.v)
